...
namespace UnitTestProject2
{
    ...
    public class UnitTest1:BaseRepository
    {
        ...
        public UnitTest1()
            : base("Data Source=192.168.4.185;Initial Catalog=CRM_Backup;Persist Security Info=True;User ID=sa;Password=wulin!111111")
        {
            orm = base.For<A_testyy>() as ORMRepository<A_testyy>;
            
        }

        ORMRepository<A_testyy> orm;
        ...
        {
            List<viewT> p = base.Query<viewT>("select a.age,a.keys,z.class as classname from a_testzhu z left join  a_testage a on z.keys=a.keys where a.keys=@Key and z.class=@Class", new { Key = "abc", Class ="2"});
            Assert.IsNotNull(p);
        ...
        {
            int r = orm.Delete(where => where.Id >35);
            Assert.IsTrue(r>-1);
        }
        [TestMethod]
        ...
        public void TestPageEntity()
        {
            ...
            Assert.IsTrue(r .Total==5&&r.DataList.Count==3);
        }
        [TestMethod]
        public void Tes1111()
        {
